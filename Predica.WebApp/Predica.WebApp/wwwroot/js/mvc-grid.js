...
var MvcGrid = (function () {
    ...
    MvcGrid.prototype = {
        ...
        bindPager: function (grid) {
            if (grid.pager) {
                grid.pager.rowsPerPage.parent().find('button').on('click', function () {
                    var rowsPerPage = $(this).data('rows-per-page');
                    if (rowsPerPage) {
                        grid.pager.rowsPerPage.val(rowsPerPage);
                ...
                '<div class="popup-content">' +
                    '<div class="first-filter popup-group">' +
                     ...
                     '<div class="popup-button-group">' +
                        '<button class="uk-button uk-button-success mvc-grid-apply" type="button">' + filterLang.Apply + '</button>' +
                        '<button class="uk-button uk-button-danger mvc-grid-cancel" type="button">' + filterLang.Remove + '</button>' +
                     '</div>' +
                 '</div>');
        },
